 ...
 */
class Magestore_Shopbybrand_Block_Layer_View extends Mage_Core_Block_Template
{
    /**
     * State block name
     *
    ...
    {
        $this->_stateBlockName              = 'shopbybrand/layer_state';
        $this->_categoryBlockName           = 'shopbybrand/layer_filter_category';
        $this->_attributeFilterBlockName    = 'shopbybrand/layer_filter_attribute';
        $this->_priceFilterBlockName        = 'shopbybrand/layer_filter_price';
        $this->_decimalFilterBlockName      = 'shopbybrand/layer_filter_decimal';
    }
    ...
    {
        return 'shopbybrand/layer_filter_attribute';
    }
