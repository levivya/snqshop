 ...
 */
class Magestore_Shopbybrand_Block_Layer_Filter_Attribute  extends Mage_Core_Block_Template
{
    public
    function __construct()
    {
        parent::__construct();
        $this->_filterModelName = 'shopbybrand/layer_filter_attribute';
        $this->setTemplate('shopbybrand/layer/filter.phtml');
    }
