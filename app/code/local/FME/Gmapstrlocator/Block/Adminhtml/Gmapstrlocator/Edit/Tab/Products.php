...
class FME_Gmapstrlocator_Block_Adminhtml_Gmapstrlocator_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _getProduct(){
		...
		return Mage::registry('current_products_gmaps');
	}
	...
	protected function _addColumnFilterToCollection($column){
		...
		if ($column->getId() == 'in_products') {
			    ...
			    $productIds = $this->_getSelectedGmapProducts();
	...
	protected function _prepareColumns(){
		...
		if (!$this->isReadonly()) {
			  ...
			  'type'              => 'checkbox',
			  'name'              => 'in_products',
			  'values'            => $this->_getSelectedGmapProducts(),
			  'align'             => 'center',
			  'index'             => 'entity_id'
		      ));
		  }
	...
	public function _getSelectedGmapProducts(){
	
		$products = null;
		
		$products = array_keys($this->getProductGmaps());
	...
	public function getProductGmaps(){
