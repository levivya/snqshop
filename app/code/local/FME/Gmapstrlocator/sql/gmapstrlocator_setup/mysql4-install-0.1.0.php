...
CREATE TABLE {$this->getTable('gmapstrlocator')} (
                `gmapstrlocator_id` int(11) unsigned NOT NULL auto_increment,  
                  ...
                  `store_identifier` varchar(255) default '',
                  ...
                  `linked_attributes` varchar(255) default NULL,                 
                  `store_marker` varchar(255) default NULL,
...
DROP TABLE IF EXISTS {$this->getTable('gmapstrlocator_attributes')};
CREATE TABLE {$this->getTable('gmapstrlocator_attributes')} (                   
                             `attributes_id` int(11) unsigned NOT NULL auto_increment,  
                             `attributes_name` varchar(255) NOT NULL default '',        
                             `attributes_status` smallint(6) NOT NULL default '0',      
                             `created_time` datetime default NULL,                      
                             `update_time` datetime default NULL,                       
...
$installer->setConfigData('gmapstrlocator/info_popup/enable_mouseover_marker',1);
$installer->setConfigData('gmapstrlocator/info_popup/enable_marker_numbers',1);
$installer->setConfigData('gmapstrlocator/info_popup/enable_sidebar_markers',1);
